<?php 
    ...
    class Model extends Base {
        ...
        private function getMedooOptions() {
            require_once __DIR__.'/../dboptions.php'; //Pull In basic $db_optios array
            
            $db_options = array(
                'database_type' => $db_baseoptions['database_type'],
                'database_name' => $db_baseoptions['database_name'],
                'server' => $db_baseoptions['server'],
                'username' => $db_baseoptions['username'],
                'password' => $db_baseoptions['password'],
                'port' => $db_baseoptions['port'],
