...
class OverviewTable extends BaseTable {
    ...
    viewFormatter = (cell, row) => {
        return <Link to={'/session-results/presentations/details/' + row.presentationId}><button className="btn btn-sm btn-primary"><i className="fa fa-eye"></i> View</button></Link>;
    }
