...
import { getOptions, getSort, getPhonenumberFormatter, getLabelFormatter } from '../../base/BaseTable';
        ...
        return (
            <div>
                <BootstrapTable pagination data={data} options={getOptions()} search>
                    <TableHeaderColumn width="100" headerAlign='center' dataSort caretRender={getSort} dataField='account_id' dataFormat={getPhonenumberFormatter} >Account ID</TableHeaderColumn>
                    ...
                    <TableHeaderColumn width="100" headerAlign='center' dataAlign='center' dataSort caretRender={getSort} dataField='origin' dataFormat={getLabelFormatter} >Origin</TableHeaderColumn>
