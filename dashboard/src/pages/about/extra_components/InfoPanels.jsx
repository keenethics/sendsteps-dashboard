...
class BaseAddinInfoPanel extends React.Component {
  state = {
    downloadUrl: ''
  };

  getDowloadAddInUrl = userId => {
    post(
      '',
      'getDownloadAddInUrl',
      { userId },
  ...
  componentDidMount() {
    ...
    this.getDowloadAddInUrl(userId);
  }
      ...
      <div className="col-md-6 mt-3">
        <div className="card">
          <div className="card-body">
            ...
            <p>
              Have all your add-in items branded in the corporate style of your organization:
              instruction-, question- and result slides, the response website and even the entire
              software package.
            </p>

            <a href="https://www.sendsteps.com/en/download/branding-design/" target="_blank">
              <button className="btn btn-outline-secondary">
                <i className="fa fa-info" /> More information
              </button>
            </a>
          </div>
        </div>
...
export const AddinInfoPanel = connect(state => {
  return {
        ...
        <div className="card-body">
          ...
          <a href="https://www.sendsteps.com/en/about/blog/" target="_blank">
            <button className="btn btn-primary">
              <i className="fa fa-rss" /> Sendsteps Blog
            </button>
          </a>
        </div>
      </div>
    ...
    <div className="col-md-6 mt-3">
      <div className="card">
        <div className="card-body">
          ...
          <p>
            <i className="fa fa-phone" /> +31 (0)20 716 36 56
          </p>
          <p>
            <i className="fa fa-envelope" /> Support@Sendsteps.com
          </p>
        </div>
      </div>
    </div>
...
export const TutorialInfoPanel = () => {
  const ytLinks = [
    ...
    },
    {
      ...
      infoText:
        'Explore the various possibilities using the extra functionalities of the Sendsteps Addin and dashboard.',
      links: [
        ...
        {section.links.map((link, linkIndex) => {
          return (
            <div key={linkIndex} className="embed-responsive embed-responsive-16by9">
              <iframe title={section.title} src={link} frameBorder="0" allowFullScreen />
            </div>
          );
        })}
      </div>
