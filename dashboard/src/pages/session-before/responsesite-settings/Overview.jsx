...
class SettingsOverview extends React.Component {
  ...
  getPhonenumberList = isoCode => {
    post(
      ...
      { isoCode },
      ({ result: phoneNumbers }) =>
        this.props.dispatch(setResponsePhonenumbers(this.formatPhonenumbers(phoneNumbers))),
    ...
    return (
      <div>
        <HeaderPanel
          ...
          content={
            <p>
              On this page you can edit your session details, for example the way your audience can
              respond, via SMS, a (mobile) website or Twitter. Click on the question marks to learn
              more about the different functionalities.
            </p>
          }
        />
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12">
                ...
                <div className="card-body">
                  <div className="form-horizontal">
                    ...
                    <div className="card border-0">
                      {settings && (
                        <Collapse in={!!(settings && !!settings.internetselected)}>
                          <span>
                            <ResponseURLInput />
                          </span>
                        </Collapse>
                    ...
                    <div className="card border-0">
                      {settings && (
                        <Collapse in={!!(settings && !!settings.textmessagingselected)}>
                          <span>
                            <ResponseCountryInput getPhonenumberList={this.getPhonenumberList} />
                            <ResponseInternationalInput
                              getPhonenumberList={this.getPhonenumberList}
                            />
              ...
              <BottomSaveBar
                loading={isLoading}
                onSave={this.saveResponseSiteSettings.bind(this)}
              />
            </div>
          </div>
        </div>
