...
class PlaySurveyModal extends Component {
    ...
    render() {
        ...
        return (
            <Modal className="small" show={!!currentSurveyToPlay} onHide={this.handleClose.bind(this)}>
                ...
                <Modal.Footer>
                    <div className="btn btn-sm btn-success" onClick={this.startSurvey}><i className="fa fa-play"></i> Start</div>
                    <div className="btn btn-sm btn-primary" onClick={this.handleClose.bind(this)}><i className="fa fa-times"></i> Cancel</div>
                </Modal.Footer>
            </Modal>
        );
    }
